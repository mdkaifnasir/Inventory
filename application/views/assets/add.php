<div class="max-w-[1000px] mx-auto">
    ...
    <nav class="flex items-center gap-2 text-sm text-gray-400 mb-6">
        ...
        <span class="material-symbols-outlined text-xs">chevron_right</span>
        <span class="text-gray-900 font-bold">Add New Item</span>
    </nav>

    <!-- Page Heading -->
    <div class="mb-8">
        <h1 class="text-3xl font-extrabold text-gray-900 tracking-tight">Add New Inventory Item</h1>
        <p class="text-gray-500 mt-1">Register new hardware or electronics into the department database.</p>
    </div>
    ...
    <?php echo form_open('assets/store', ['class' => 'space-y-6']); ?>
        ...
        <div class="p-6 grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="md:col-span-2">
                    ...
                    <div class="relative">
                        <select name="name" id="item_type_select"
                            class="w-full h-12 px-4 rounded-lg border border-gray-200 focus:ring-4 focus:ring-primary-500/10 focus:border-primary-600 transition-all font-medium disabled:bg-gray-50 disabled:text-gray-400 appearance-none bg-none"
                            disabled>
            ...
            <div class="col-span-full grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input name="hard_disk"
                        class="w-full h-12 px-4 rounded-lg border border-gray-200 focus:ring-4 focus:ring-primary-500/10 focus:border-primary-600 transition-all"
                        placeholder="e.g. 1 TB / 256 SSD" type="text" value="<?php echo set_value('hard_disk'); ?>" />
                </div>
                <div>
                    <label class="block text-xs font-bold text-gray-500 uppercase mb-2">Operating System</label>
                    <input name="os"
                        class="w-full h-12 px-4 rounded-lg border border-gray-200 focus:ring-4 focus:ring-primary-500/10 focus:border-primary-600 transition-all"
                        placeholder="e.g. Win 10" type="text" value="<?php echo set_value('os'); ?>" />
                </div>
                <div>
                    ...
                    <input name="assigned_to"
                        ...
                        value="<?php echo set_value('assigned_to'); ?>" />
                </div>
            </div>
            ...
            <div class="col-span-full">
                ...
                <textarea name="amc_details"
                    ...
                    rows="2"><?php echo set_value('amc_details'); ?></textarea>
            </div>
            ...
            <div class="col-span-full">
                ...
                <textarea name="remarks"
                    class="w-full p-4 rounded-lg border border-gray-200 focus:ring-4 focus:ring-primary-500/10 focus:border-primary-600 transition-all"
                    rows="2"><?php echo set_value('remarks'); ?></textarea>
            </div>
            <div class="col-span-full">
                <label class="block text-xs font-bold text-gray-400 uppercase tracking-widest mb-3">Asset
                    Condition</label>
                <input type="hidden" name="asset_condition" id="asset_condition_input" value="Working">
                <div class="grid grid-cols-2 md:grid-cols-4 gap-3">
                    <button type="button" onclick="setFullCondition('New', this)"
                        ...
                        <span class="material-symbols-outlined text-lg">fiber_new</span> New
                    </button>
                    <button type="button" onclick="setFullCondition('Working', this)"
                        class="condition-btn-full flex items-center justify-center gap-2 h-14 rounded-xl border-2 border-primary-600 bg-primary-50 text-primary-600 font-black text-xs uppercase tracking-widest transition-all">
                        <span class="material-symbols-outlined text-lg">check_circle</span> Working
                    </button>
                    <button type="button" onclick="setFullCondition('Used (Good)', this)"
                        class="condition-btn-full flex items-center justify-center gap-2 h-14 rounded-xl border border-gray-200 text-gray-500 font-bold text-xs uppercase tracking-widest hover:bg-gray-50 transition-all">
        ...
        <div class="p-6 grid grid-cols-1 md:grid-cols-3 gap-6 items-start">
            <div class="md:col-span-2 space-y-6">
                <div>
                    ...
                    <input name="serial_number"
                        ...
                        placeholder="SN-XXXX-XXXX-XXXX" type="text" value="<?php echo set_value('serial_number'); ?>" />
                </div>
                <div>
                    ...
                    <div class="flex gap-2">
                        <input id="asset_tag_input" name="asset_tag"
                            ...
                            placeholder="COL-2024-001" type="text" value="<?php echo set_value('asset_tag'); ?>"
                            required />
            ...
            <div
                ...
                <p class="text-[10px] text-gray-400 text-center uppercase font-bold tracking-tighter">Property of
                    Engineering Dept.</p>
                <p id="tag_preview_text" class="text-xs font-mono font-bold text-gray-700 mt-1">COL-2024-XXXX</p>
            </div>
        </div>
    </section>
        ...
        <div class="p-6 grid grid-cols-1 md:grid-cols-3 gap-6">
            <div>
                ...
                <input name="purchase_date"
                    class="w-full h-12 px-4 rounded-lg border border-gray-200 focus:ring-4 focus:ring-primary-500/10 focus:border-primary-600 transition-all"
                    type="date" value="<?php echo set_value('purchase_date'); ?>" />
            </div>
            <div>
                ...
                <select name="vendor"
                    ...
                    <option value="Dell Business">Dell Business</option>
                    <option value="Amazon Business">Amazon Business</option>
                    <option value="Local Store">Local Store / Institutional Vendor</option>
                </select>
            </div>
            <div>
                ...
                <input name="warranty_expiry"
                    class="w-full h-12 px-4 rounded-lg border border-gray-200 focus:ring-4 focus:ring-primary-500/10 focus:border-primary-600 transition-all"
                    type="date" value="<?php echo set_value('warranty_expiry'); ?>" />
            </div>
        </div>
    </section>
    ...
    <section
        ...
        <div class="p-6 grid grid-cols-1 md:grid-cols-3 gap-6">
            <div>
                <label class="block text-xs font-bold text-gray-500 uppercase mb-2">Initial Location</label>
                <input name="location"
                    class="w-full h-12 px-4 rounded-lg border border-gray-200 focus:ring-4 focus:ring-primary-500/10 focus:border-primary-600 transition-all"
                    placeholder="e.g. Lab 402, Shelf B" type="text" value="<?php echo set_value('location'); ?>" />
            </div>
            <div>
                <label class="block text-xs font-bold text-gray-500 uppercase mb-2">Initial Status</label>
                <select name="status"
                    class="w-full h-12 px-4 rounded-lg border border-gray-200 focus:ring-4 focus:ring-primary-500/10 focus:border-primary-600 transition-all font-medium">
